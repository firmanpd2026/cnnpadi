...
## Hosting ke GitHub + Streamlit Community Cloud

Project ini sudah disiapkan agar bisa diupload ke GitHub dan dideploy melalui **Streamlit Community Cloud**.
...
1. Buat repository baru di GitHub, misalnya `cnn-padi-streamlit`.
...
Catatan penting: GitHub hanya menyimpan source code. Untuk menjalankan aplikasi Streamlit secara online, gunakan Streamlit Community Cloud.
